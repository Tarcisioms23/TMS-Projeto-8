package br.com.nttdata.generali.midleware.tet.vendas.producer.controller;
...
import br.com.nttdata.generali.midleware.tet.vendas.producer.service.PedidoService;
...
public class PedidoController {
    ...
    @PostMapping()
    public ResponseEntity<PedidoDto> realizaPedido(@RequestBody @Validated PedidoDto dto, UriComponentsBuilder uriBuilder) {
